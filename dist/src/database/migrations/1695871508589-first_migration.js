...
exports.FirstMigration1695871508589 = void 0;
class FirstMigration1695871508589 {
    constructor() {
        this.name = 'FirstMigration1695871508589';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TYPE "public"."user_type_enum" AS ENUM('individual', 'group')`);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "photo_url" character varying NOT NULL, "type" "public"."user_type_enum" NOT NULL DEFAULT 'individual', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
...
exports.FirstMigration1695871508589 = FirstMigration1695871508589;
//# sourceMappingURL=1695871508589-first_migration.js.map